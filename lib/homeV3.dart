                              ...
                              Expanded(
                                child: dayEntries.isEmpty
                                  ...
                                  itemBuilder: (context, mealIndex) {
                                    dynamic entry = dayEntries[mealIndex];
                                    return Dismissible(
                                        key: UniqueKey(),
                        ...
                        Visibility(
                          ...
                          child: Padding(
                            ...
                            child: AnimatedContainer(
                              duration: Duration(milliseconds: 50),
                              child: Container(
                                width: pageIndex != pageCount - 1 && pageIndex > 0
                                    ? 10
                                    : 7,
                                height: pageIndex != pageCount - 1 && pageIndex > 0
                                    ? 10
                                    : 7,
                                decoration: BoxDecoration(
                                    color: Colors.blue,
